...
The distribution of *r̂*<sup>2</sup> appears relatively normal, though
there is a slightly heavy left tail extending to low values which could
suggest the presence of some outliers in the dataset.
...
is (7.140, 7.845). The 95% confidence interval for *r̂*<sup>2</sup> is
(0.894, 0.927).
