...
Based on this cross validation, it appears that baby's head circumference at birth, baby's length at birth, and baby's sex are significant predictors for birthweight.  
...
Looking at the distribution of log(B0 * B1): 
...
Looking at the distribution of R^2: 
...
Identifying the 2.5% and 97.5% quantiles to provide a 95% confidence interval for the two quantities 
