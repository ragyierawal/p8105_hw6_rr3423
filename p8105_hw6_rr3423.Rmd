...
The babysex variable has two distinct categories, which is consistent with the homework data description. The frace variable only has five distinct categories, which is not consistent with the homework data description (category 9 'unknown' is not included in this dataset). The malform variable has two distinct categories, which is consistent with the homework data description. The mrace variable only has four distinct categories, which is not consistent with the homework data description (category 8 'other' is not included in this dataset). 
