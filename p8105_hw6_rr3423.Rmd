...
The distribution of $\log(\hat{\beta}_{0} * \hat{\beta}_{1})$ appears relatively normal, though there does appear to be a bit of a "shoulder" at the top (the graph is not a smooth curve at the peak) of the graph which could suggest the presence of outliers in the dataset. 
...
The distribution of $\hat{r}^{2}$ appears relatively normal, though there is a slightly heavy left tail extending to low values which could suggest the presence of some outliers in the dataset.
