...
At an alpha = 0.05 significance level, the following factors are significant because they have a p-value less than 0.05 in the linear regression model output: gaweeks, momage, mraceBlack, mracePuerto Rican, and wtgain. The mracePuerto Rican factor is not significant because the p-value is greater that 0.05, but not as much as it was in my original proposed linear model. 
